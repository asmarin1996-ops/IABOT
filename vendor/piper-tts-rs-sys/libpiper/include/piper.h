...
#define PIPER_EXPORT __declspec(dllexport)
#else
#define PIPER_EXPORT
#endif
 ...
 */
PIPER_EXPORT piper_synthesizer *piper_create(const char *model_path, const char *config_path,
 ...
 */
PIPER_EXPORT void piper_free(piper_synthesizer *synth);
 ...
 */
PIPER_EXPORT piper_synthesize_options
 ...
 */
PIPER_EXPORT int piper_synthesize_start(piper_synthesizer *synth, const char *text,
 ...
 */
PIPER_EXPORT int piper_synthesize_next(piper_synthesizer *synth, piper_audio_chunk *chunk);
